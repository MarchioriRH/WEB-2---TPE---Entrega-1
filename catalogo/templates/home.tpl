            ...
            <div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="./img/catalogo/Aprilia-RS-660-3_600x445.jpg" class="d-block w-100" alt="Aprilia RS-660">
                            <div class="carousel-caption d-none d-md-block aprilia">
                    ...
                    <div class="carousel-item">
                        <img src="./img/catalogo/Ford_F-150_Raptor_2021_600x344.jpg" class="d-block w-100" alt="F150 Raptor">
                            <div class="carousel-caption d-none d-md-block raptor">
                                <h5>F150 Raptor</h5>
                    ...
                    <div class="carousel-item">
                        <img src="./img/catalogo/2011LamborghiniAventador_497x227.jpg" class="d-block w-100" alt="Lamborghini Aventador 2011">
                            <div class="carousel-caption d-none d-md-block lambo">
