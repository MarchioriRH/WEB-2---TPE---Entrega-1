            ...
            {foreach from=$vehiculos item=$catalogo}
                <tr>
                    ...
                    {if (($rol == 0) && ($id_cat == null))}
                        <td><a class="btn btn-secondary" role="button" href="detallesVehiculo/{$catalogo->id_vehiculo}">Mas detalles</a></td>
                    {elseif (($rol == 0) && ($id_cat != null))}
                        ...
                        <td><a class="btn btn-secondary" role="button" href="detallesVehiculoEnCategoria/{$catalogo->id_vehiculo}">Mas detalles</a></td>
                    {/if}                   
                    ...
                    {if ($session && ($rol == 1))}
                        ...
                        {if ($id_cat != null)}
                            <td><a class="btn btn-secondary" role="button" href="detallesVehiculoEnCategoria/{$catalogo->id_vehiculo}">Mas detalles</a></td>
                            <td><a class="btn btn-secondary" role="button" href="editarVehiculoEnCategoria/{$catalogo->id_vehiculo}">Editar</a></td>
                        ...
                        {else}
                            <td><a class="btn btn-secondary" role="button" href="detallesVehiculo/{$catalogo->id_vehiculo}">Mas detalles</a></td>
                            <td><a class="btn btn-secondary" role="button" href="editarVehiculo/{$catalogo->id_vehiculo}">Editar</a></td>
                            <td><a class="btn btn-danger" role="button" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-html="true" title="<b>¡ATENCION!</b><br>El vehiculo marca {$catalogo->marca}, modelo {$catalogo->modelo}  sera eliminado de la base de datos." href="eliminarVehiculo/{$catalogo->id_vehiculo}">Eliminar</a></td>
                        {/if}
